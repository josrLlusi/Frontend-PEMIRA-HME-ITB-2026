      ...
      <nav className="fixed top-0 left-0 w-full z-[80] transition-all duration-300">
        <div className="mx-auto px-4 md:px-8 py-3 flex justify-between items-center bg-black/40 backdrop-blur-md border-b border-white/5">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            <button onClick={() => router.push('/livecount')} className="min-w-[85px] md:min-w-[120px] h-8 md:h-10 px-4 border border-[#FFC045]/40 rounded-full flex items-center justify-center hover:bg-[#FFC045]/10 transition-all text-[#FFC045] font-bold text-[10px] md:text-sm tracking-wide whitespace-nowrap">
